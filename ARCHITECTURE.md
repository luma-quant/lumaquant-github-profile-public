...
profile/README.md
        |
        v
GitHub repository profile renderer
        |
        v
...
`RELEASE.json` classifies the artifact and binds a canonical source digest.
...
No architectural statement in this repository establishes production parity for
